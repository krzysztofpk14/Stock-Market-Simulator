...
/**
 * Unit tests for the MovingAverageCrossoverStrategy class.
...
public class MovingAverageCrossoverStrategyTest {
    ...
    public void setUp() {
        ...
        strategy = new MovingAverageCrossoverStrategy(testClient);
        
        // Create and initialize parameters
        parameters = new StrategyParameters();
        parameters.setInstruments(Arrays.asList("KGHM", "PKO"))
                .setParam("shortSMAPeriod", 5)  // Use small periods for testing
                .setParam("longSMAPeriod", 10)
    ...
    public void testGetters() {
        // Test basic getters
        assertEquals("Moving Average Crossover Strategy", strategy.getName(), 
